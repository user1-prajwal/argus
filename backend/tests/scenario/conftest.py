"""Shared fixtures for Scenario module tests."""
...
def planning_engine(
    ...
    """A PlanningEngine bound to the other fixtures."""
...
def runner(
    ...
    """A ScenarioRunner bound to the other fixtures, all sharing the
    same underlying World, AgentRegistry, and MissionRegistry.
    """
...
def make_mission() -> Callable[..., Mission]:
    ...
    def _make_mission(
        ...
        description: str = "A mission used for Scenario Runner tests.",
